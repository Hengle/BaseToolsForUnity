...
namespace NZQLA
{
    ...
    {
        private static string strPathLogFile = "Log.txt";
        private static List<string> arrLog = new List<string>();
        ...
        public static void SaveLogToFile(bool bAppend = true)
        {
            ...
            FileTool.WriteStringToFileByFileStream(
                strPathLogFile, sb.ToString(),
                () => { Log.LogAndSave("将Log日志写入文件 " + strPathLogFile, LogErrorType.Normal, true, false); },
                Encoding.UTF8,
                bAppend);
        ...
        /// <param name="bAddTime"></param>
        /// <param name="bSave"></param>
        public static void LogAtUnityEditorError(string strLog, bool needLogInvokeSource = false, bool bAddTime = true, bool bSave = true)
        {
            ...
            LogAtUnityEditor(sb.ToString(), "#ff0000ff", LogErrorType.Error, bAddTime, bSave);
        }
