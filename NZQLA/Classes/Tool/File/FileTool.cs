...
namespace NZQLA
{
    ...
    public class FileTool
    {
        ...
        /// <returns></returns>
        public static FileInfo[] GetFileinfosAtDirectory(string strDirectoryPath, SearchOption searchOption = SearchOption.TopDirectoryOnly
        ...
        /// <returns></returns>
        public static bool isEmptyDirecory(DirectoryInfo info)
        {
            if (info == null)
                return true;
        ...
        /// <returns></returns>
        public static bool isEmptyDirecory(string strDirectoryPath)
        {
        ...
        public static void WriteStringToFileByFileStream(string strPath, string data, Action CallBackOnFinsihWrite, Encoding encoding, bool bAppend)
        {
        ...
        /// <param name="encoding">写入时采用的编码格式</param>
        /// <param name="bAppend">是否是续写</param>
        public static void WriteStringToFileByStreamWriter(string strPath, string data, Action CallBackOnFinsihWrite, Encoding encoding, bool bAppend)
        {
            if (string.IsNullOrEmpty(strPath))
                return;
        ...
        public static void WriteBytesToFileByBinary(string outFilePath, byte[] data)
        {
            EnsureDirectoryExist(outFilePath);
        ...
        /// <returns></returns>
        public static string ReadFile(string strPath, Encoding encoding, Action CallBackOnFinsihRead, bool detectEncodingFromByteOrderMarks = true)
        {
            ...
            if (CallBackOnFinsihRead != null)
                CallBackOnFinsihRead.Invoke();
        ...
        /// <param name="detectEncodingFromByteOrderMarks"></param>
        /// <returns></returns>
        public static List<string> ReadFileAllLines(string strPath, Encoding encoding, Action CallBackOnFinsihRead, bool detectEncodingFromByteOrderMarks = true)
        {
            if (!File.Exists(strPath))
                return null;
        ...
        /// <param name="detectEncodingFromByteOrderMarks"></param>
        /// <returns></returns>
        public static string ReadFileLine(string strPath, int Line, Encoding encoding, Action CallBackOnFinsihRead, bool detectEncodingFromByteOrderMarks = true)
        {
        ...
        public static void EnsureDirectoryExist(string strPath)
        {
            if (string.IsNullOrEmpty(strPath))
                return;
        ...
        /// <param name="strPath"></param>
        /// <returns></returns>
        public static string ToRecsourcesPath(string strPath)
        {
            if (string.IsNullOrEmpty(strPath))
                return null;
        ...
        /// <param name="strFullPath"></param>
        /// <returns></returns>
        public static string PhysccalFullPathToAssetPath(string strFullPath)
        {
            if (string.IsNullOrEmpty(strFullPath))
                return null;
        ...
        /// <param name="strFullPath"></param>
        /// <returns></returns>
        public static string PhysccalFullPathToStreamingPath(string strFullPath)
        {
            if (string.IsNullOrEmpty(strFullPath))
                return null;
        ...
        /// <param name="strPath"></param>
        /// <returns></returns>
        public static string StreamingPathToPhysccalFullPath(string strPath)
        {
            if (string.IsNullOrEmpty(strPath))
                return null;
        ...
        public static string RecsPathToPhySicalFullPath(string strPath, RecsPathType from)
        {
            ...
            switch (from)
            {
                ...
                case RecsPathType.StreamingPath:
                    return StreamingPathToPhysccalFullPath(strPath);
